...
${DB_INIT_SNIPPET}
    ...
    function messageUpdateFingerprint(message, index) {
        ...
        const fp = String(index) + '|' + swipe + '|' + String(hash);
        try { messageUpdateFpCache.set(message, { text, swipe, index, fp }); } catch (e) {}
        return fp;
    }
